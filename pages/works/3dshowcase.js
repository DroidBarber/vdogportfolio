...
const Work = () => (
  <Layout title="3dshow">
    <Container>
      ...
      <P>
        This project aims to build a Web Application using ThreeJS, facilitated by React Three Fiber—a React renderer for ThreeJS and finally  Framer-Motion, a popular animation library for react, that is used to load, create and customize stunning 3D models, the example used in the demo is a Shirt model that comes with 3 features, custom coloring, image upload and the possibility to prompt OpenAI Image generation Engine DALL-E and display the results on the model.
      </P>
      <List ml={4} my={4}>
        <ListItem>
          <Meta>Website</Meta>
